...
function ProjectDetails() {
  ...
  return (
    ...
    <section className="container px-8  md:px-20 lg:px-40 mt-10">
      <div className="mb-10">
        <button
          className=" text-msm flex items-center gap-2 hover:text-main hover:drop-shadow-glow"
          onClick={() => navigate("/projects")}
        >
          <IoIosArrowBack /> <p>Go to projects</p>
        </button>
      </div>
            ...
            <div className="mt-5">
              ...
              <div className="flex justify-center py-3">
                {features.length > 0 ? (
                  ...
                  <p className="text-secondary-text text-msm">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3 rounded-lg mt-4">
                {technologies &&
                  technologies.map(
                    (tech, index) =>
                      Object.hasOwn(icons, tech.toUpperCase()) && (
                        <div
                          key={index}
                          className="w-[2.5rem] h-[2.5rem] p-2  bg-secondary-bg rounded-md"
                        >
                          <img
                            src={icons[tech.toUpperCase()]}
                            alt={`${tech}`}
            ...
            <div className="mt-6 text-sm flex flex-col gap-5">
              {live_link && (
                <div className="flex gap-3 items-center">
                  ...
                  <Link
                    to={live_link}
                    className="hover:drop-shadow-glow hover:text-main"
                  >
                    View Live
                  </Link>
                </div>
